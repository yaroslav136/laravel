...
var getConfig = function(options) {
    ...
    var baseTinymceConfig = {
        ...
        toolbar: 'styleselect | bold italic underline | forecolor backcolor | alignleft aligncenter alignright | bullist numlist outdent indent | link image table | code | fontfamily fontsize blocks',
        image_caption: true,
        image_title: true,
